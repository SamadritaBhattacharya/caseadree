...
const DesignConfigurator = ({
  ...
  const {mutate: saveConfig} = useMutation({
    ...
    mutationFn: async (args: SaveConfigArgs) => {
      //simultaneously executing both the cropped image and the db update 
    ...
    const [options, setOptions] = useState<{
      ...
      //for taking the size of the image 
      ...
      //for taking the position (x-y coordinates of the cropped image )
      ...
      function base64ToBlob(base64: string, mimeType: string){
        //converting base64(string) to a png format
