//loading, not paid to our shop from stripe, paid
//get the status of db (calling both the ty page as well as the webhook)
          ...
          <div className='mt-10 border-t border-zinc-200'>
            <div className='mt-10 flex flex-auto flex-col'>
              ...
              <p className='mt-2 text-sm text-zinc-600'>
                We at CaseaDree believe that a phone case doesn't only need to
